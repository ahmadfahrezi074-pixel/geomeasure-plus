<div
  key={index}
  className={`relative bg-white/5 border border-white/10 rounded-[40px] overflow-hidden backdrop-blur-2xl shadow-2xl transition-all duration-700 ease-in-out hover:scale-[1.02] hover:border-cyan-400/30 hover:shadow-cyan-500/10
